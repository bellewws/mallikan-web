...
<div class="hero-wrap hero-bread" style="background-image: url('/images/bg-nelayan.jpg'); padding-bottom: 100px;">
    <div class="container">
  ...
  <div class="text-center" style="padding-top: 30px">
    <ul class="product-category">
        <li><a href="{{url('kategori/ikan')}}" class="{{ Request::is('kategori/ikan') ? 'active' : '' }}">Ikan</a></li>
        <li><a href="{{url('kategori/udang')}}" class="{{ Request::is('kategori/udang') ? 'active' : '' }}">Udang</a></li>
        <li><a href="{{url('kategori/kerang')}}" class="{{ Request::is('kategori/kerang') ? 'active' : '' }}">Kerang</a></li>
        <li><a href="{{url('kategori/kepiting')}}" class="{{ Request::is('kategori/kepiting') ? 'active' : '' }}">Kepiting</a></li>
        <li><a href="{{url('kategori/cumi')}}" class="{{ Request::is('kategori/cumi') ? 'active' : '' }}">Cumi</a></li>
    </ul>
  </div>
  <div class="d-flex">
    <div class="p-6 sidebar-produk"  style="padding-top: 80px">
    <div id="produk"></div>
      @include('layouts.sidebar-produk')
    </div>
    <div class="p-6" style="padding-left: 20px; padding-top: 60px">
    <section class="ftco-section" style="width: 1000px">
    <div class="container">
                      ...
                      <div class="text py-3 pb-4 px-3 text-center">
                          ...
                          <div class="d-flex">
                              <div class="pricing">
                                  ...
                                  <p><span>{{$p->toko->kota->title}}</span></p>
